package com.solace.ep.eclipse.test;
...
public class Snippet026TreeViewerTabEditing {
	...
	private ColumnLabelProvider createColumnLabelProvider(final String prefix) {
		return new ColumnLabelProvider() {
			...
			Image i = new Image(Display.getCurrent(), getClass().getResourceAsStream("/hex-small-pub.png"));

			
			@Override
			public Image getImage(Object element) {
				return i;
//				return PlatformUI.getWorkbench().getSharedImages().getImageDescriptor(ISharedImages.IMG_OBJS_INFO_TSK).createImage();
			}
